      ...
      <section className="flex flex-col items-center">
        <div className="w-4/5">
          ...
          <div className="flex flex-col gap-4 my-8">
            ...
            <p className="text-sm">
              NOTE: If you have performed work hours and they are not shown,
              they may not have been added yet or you should contact the
              director who was supervising the project and confirm that the
              hours have been submitted.
            </p>
            <p>
              Work-hours forms are available in the lower floor of the club
              house and are collected by the Club Administrator on a regular
              basis. Thank you CYC Members!!
            </p>
          </div>
          ...
          <ul className="list-disc list-inside mb-8 space-y-3 tracking-wide">
            ...
            <li>
              Sand and paint the bar to match the front door blue. (Winter
              Months)
            </li>
            ...
            <li>
              Install former upper TV onto wall in entrance room. (Winter
              Months)
            </li>
