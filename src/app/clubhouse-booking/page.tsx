        ...
        <div className="flex flex-col w-4/5 gap-4">
          ...
          <div className="px-6 py-4 mb-6">
            ...
            <div className="flex flex-col w-full items-center">
              ...
              <p className="mb-4">
                The clubhouse and its facilities are available to all members
                and visiting overnight boaters.
              </p>
            ...
            <div className="bg-amber-50 rounded-lg px-6 py-4 mb-6 mt-8">
              ...
              <p className="mb-4 w-4/5 leading-5">
                ...
                clean, furniture away) you can be charged a $25/ hr cleaning
                fee.
              </p>
              <p className="mb-4 w-4/5 leading-5">
              ...
              <p className="mb-4">
                Excessive use of the facilities by any club member may incur
                usage fees.
              </p>
